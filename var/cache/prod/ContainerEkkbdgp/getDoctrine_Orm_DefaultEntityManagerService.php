...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ClasseBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\MatierBundle\\Entity')]);
...
$a->setEntityNamespaces(['UserBundle' => 'UserBundle\\Entity', 'ClasseBundle' => 'ClasseBundle\\Entity', 'MatierBundle' => 'MatierBundle\\Entity']);
