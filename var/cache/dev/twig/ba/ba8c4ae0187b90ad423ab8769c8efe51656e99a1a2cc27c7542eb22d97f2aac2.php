...
class __TwigTemplate_95b616d9c174481e0bf41a58e9f80b2b92c8b605950c6e68bb1ad1af9f6d8977 extends \Twig\Template
{
...
Nous Avons accepter votre enfant ";
        // line 3
        echo twig_escape_filter($this->env, (isset($context["nomEnfant"]) ? $context["nomEnfant"] : $this->getContext($context, "nomEnfant")), "html", null, true);
        echo "<br>
dans le date ";
        // line 4
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date"))), "html", null, true);
