...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ClasseBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\MatierBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\GarderieBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\EvenementBundle\\Entity'), 5 => ($this->targetDirs[3].'\\vendor\\adesigns\\calendar-bundle\\ADesigns\\CalendarBundle\\Entity'), 6 => ($this->targetDirs[3].'\\vendor\\toiba\\fullcalendar-bundle\\Entity'), 7 => ($this->targetDirs[3].'\\src\\MonLivreBundle\\Entity')]);

$b->addDriver($c, 'UserBundle\\Entity');
$b->addDriver($c, 'ClasseBundle\\Entity');
$b->addDriver($c, 'MatierBundle\\Entity');
$b->addDriver($c, 'GarderieBundle\\Entity');
...
$b->addDriver($c, 'MonLivreBundle\\Entity');
...
$a->setEntityNamespaces(['UserBundle' => 'UserBundle\\Entity', 'ClasseBundle' => 'ClasseBundle\\Entity', 'MatierBundle' => 'MatierBundle\\Entity', 'GarderieBundle' => 'GarderieBundle\\Entity', 'EvenementBundle' => 'EvenementBundle\\Entity', 'ADesignsCalendarBundle' => 'ADesigns\\CalendarBundle\\Entity', 'FullCalendarBundle' => 'Toiba\\FullCalendarBundle\\Entity', 'MonLivreBundle' => 'MonLivreBundle\\Entity']);
