...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'evenementbundle\\eventlistener\\fullcalendarlistener' => 'EvenementBundle\\EventListener\\FullCalendarListener',
        ...
        $this->fileMap = [
            ...
            'EvenementBundle\\EventListener\\FullCalendarListener' => 'getFullCalendarListenerService.php',
            ...
            'fullcalendar.service.calendar' => 'getFullcalendar_Service_CalendarService.php',
        ...
        $this->privates = [
            ...
            'EvenementBundle\\EventListener\\FullCalendarListener' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('eJdUWaS2mL', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gwWclxgchX', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o9RwhxHwBB', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rt9-qozqN+', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('fullcalendar.set_data', [0 => function () {
            return ${($_ = isset($this->services['EvenementBundle\\EventListener\\FullCalendarListener']) ? $this->services['EvenementBundle\\EventListener\\FullCalendarListener'] : ($this->services['EvenementBundle\\EventListener\\FullCalendarListener'] = new \EvenementBundle\EventListener\FullCalendarListener())) && false ?: '_'};
        }, 1 => 'loadEvents'], 0);
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a820bc7f28317f7ecf00fcaccd8b737e696e442f'))) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\UserBundle/Resources/views'), '!User');
        $instance->addPath(($this->targetDirs[3].'\\src\\ClasseBundle/Resources/views'), 'Classe');
        $instance->addPath(($this->targetDirs[3].'\\src\\ClasseBundle/Resources/views'), '!Classe');
        $instance->addPath(($this->targetDirs[3].'\\src\\MatierBundle/Resources/views'), 'Matier');
        $instance->addPath(($this->targetDirs[3].'\\src\\MatierBundle/Resources/views'), '!Matier');
        $instance->addPath(($this->targetDirs[3].'\\src\\GarderieBundle/Resources/views'), 'Garderie');
        $instance->addPath(($this->targetDirs[3].'\\src\\GarderieBundle/Resources/views'), '!Garderie');
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\adesigns\\calendar-bundle\\ADesigns\\CalendarBundle/Resources/views'), '!ADesignsCalendar');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\toiba\\fullcalendar-bundle/Resources/views'), 'FullCalendar');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\toiba\\fullcalendar-bundle/Resources/views'), '!FullCalendar');
        $instance->addPath(($this->targetDirs[3].'\\src\\MonLivreBundle/Resources/views'), 'MonLivre');
        $instance->addPath(($this->targetDirs[3].'\\src\\MonLivreBundle/Resources/views'), '!MonLivre');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a820bc7f28317f7ecf00fcaccd8b737e696e442f');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'ClasseBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\ClasseBundle'),
                    'namespace' => 'ClasseBundle',
                ],
                'MatierBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MatierBundle'),
                    'namespace' => 'MatierBundle',
                ],
                ...
                'GarderieBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\GarderieBundle'),
                    'namespace' => 'GarderieBundle',
                ],
                'KnpPaginatorBundle' => [
                    'parent' => NULL,
                ...
                'FullCalendarBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\vendor\\toiba\\fullcalendar-bundle'),
                    'namespace' => 'Toiba\\FullCalendarBundle',
                ],
                'MonLivreBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MonLivreBundle'),
                    'namespace' => 'MonLivreBundle',
                ],
                'VichUploaderBundle' => [
                    'parent' => NULL,
            ...
            case 'vich_uploader.mappings': $value = [
                'Monlivre' => [
                    'uri_prefix' => 'Uploads',
                    'upload_destination' => ($this->targetDirs[3].'/web/Uploads/'),
                    'namer' => [
                        'service' => NULL,
                        'options' => NULL,
                    ],
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'ClasseBundle' => 'ClasseBundle\\ClasseBundle',
                'MatierBundle' => 'MatierBundle\\MatierBundle',
                'CMENGoogleChartsBundle' => 'CMEN\\GoogleChartsBundle\\CMENGoogleChartsBundle',
                'GarderieBundle' => 'GarderieBundle\\GarderieBundle',
                ...
                'FullCalendarBundle' => 'Toiba\\FullCalendarBundle\\FullCalendarBundle',
                'MonLivreBundle' => 'MonLivreBundle\\MonLivreBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'ecole-1',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'rzougaa123456789',
            'mailer_password' => 'azertyuiop.',
            'secret' => 'a820bc7f28317f7ecf00fcaccd8b737e696e442f',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'a820bc7f28317f7ecf00fcaccd8b737e696e442f',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'rzougaa123456789',
            'swiftmailer.mailer.default.transport.smtp.password' => 'azertyuiop.',
