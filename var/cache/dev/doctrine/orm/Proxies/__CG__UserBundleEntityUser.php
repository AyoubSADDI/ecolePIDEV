...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'cin', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'sexe', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'dateNaissance', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'tel', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'matiere', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'classe', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'affecter', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'niveau', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'loisir', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'parent', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'prenom', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function isAffecter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isAffecter', []);

        return parent::isAffecter();
    }
    ...
    public function setAffecter($affecter)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAffecter', [$affecter]);
    ...
    public function getLoisir()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLoisir', []);

        return parent::getLoisir();
    }
    ...
    public function setLoisir($loisir)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLoisir', [$loisir]);

        return parent::setLoisir($loisir);
    }
